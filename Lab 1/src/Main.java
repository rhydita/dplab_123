...
public class Main {
    public static void main(String[] args) {
        ...
        PaymentMethod cardPayment = new CreditCard("1234-5678-9876-5432", "TukTuk", "12/28", 123);
        PaymentMethod paypalPayment = new PayPal("tuktuk02@meow.com");

        // Create Riders
        Rider rider1 = new Rider(1, "Hasina", paypalPayment);
        Rider rider2 = new Rider(2, "Zia", cardPayment);

        // Create Drivers
        Driver driver1 = new Driver(1, "Kader", carpool);
        Driver driver2 = new Driver(2, "Babar", luxury);
        Driver driver3 = new Driver(3, "Tarek", bike);
        ...
        Trip trip2 = rider2.requestRide("Bashundhara", "Uttara", bike);
